...
const VERSION = 'foxdrop-app-10';
const SHELL = ['./', 'index.html', 'style.css', 'app.js', 'fox-chat.svg', 'sprite.svg', 'icon-192.png', 'icon-512.png', '../icon.svg', 'manifest.webmanifest', 'qrcode.js'];
